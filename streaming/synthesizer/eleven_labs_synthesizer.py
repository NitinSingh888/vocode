...
class ElevenLabsSynthesizer(BaseSynthesizer[ElevenLabsSynthesizerConfig]):
    def __init__(
        ...
        if synthesizer_config.ignore_usample_and_output_format:
    ...
    async def get_chunks(
        ...
        try:
            ...
            print(f"start time for TTS: {start_time}, first chunk received: {first_chunk_time}, last chunk received: {last_chunk_time}")
        except asyncio.CancelledError:
            pass
        except Exception as e:
            print("An error occurred in TTS API CALL: {}".format(e))
            pass
        finally:
